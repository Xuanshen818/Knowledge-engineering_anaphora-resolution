...
for i, data in enumerate(json_data):
    ...
    words_before_pronoun = sentence[:pronoun_index_behind].split()  # 修改此处
    ...
    # 补全特征向量使其与最长的句子等长
    sentence_features += [np.zeros_like(encoder.categories_[0][0])] * (400 - len(sentence_features))
    ...
    # 补全标签向量使其与最长的句子等长
    sentence_labels += [0] * (400 - len(sentence_labels))
